...
export function Login({ onLogin }: LoginProps) {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4 relative">
          ...
          >
            <div className="relative w-full h-full">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-black text-center font-bold" style={{ fontSize: '18px' }}>Login</span>
              </div>
            </div>
          </button>
        ) : (
          <div className="bg-white p-4 rounded-lg shadow-xl border-2 border-purple-600" style={{ width: '280px' }}>
            <div className="flex flex-col gap-3">
              ...
              <div className="flex gap-2">
                <button
                  onClick={handleLogin}
                  disabled={isLoading}
                  className="flex-1 bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-4 rounded transition-colors disabled:opacity-50"
                >
      ...
      <div className="flex flex-col items-center justify-center -mt-18 gap-0 w-full max-w-7xl mx-auto px-4">
        <img src={loginImage} alt="CoHive - Insight into Inspiration" className="max-w-4xl w-full h-auto mb-[-50px] z-0" />
        <div className="flex flex-col items-center z-10 relative">
          <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-[68px] leading-tight text-black text-center whitespace-nowrap" style={{ fontFamily: 'Poppins, sans-serif' }}>
            Collaborative Marketing Intelligence
          </h1>
          <div className="inline-flex flex-col items-start" style={{ maxWidth: 'min-content' }}>
            <p className="text-2xl md:text-2xl lg:text-3xl xl:text-[34px] leading-tight text-black text-center w-full whitespace-nowrap" style={{ fontFamily: 'Poppins, sans-serif', fontStyle: 'italic' }}>
              Human Creativity with AI Insights for Precision Decision-Making
            </p>
            <div className="mt-8 text-center w-full" style={{ fontFamily: 'Lato, sans-serif' }}>
              <p className="text-lg md:text-xl leading-relaxed text-gray-800 pb-4">
              ...
              <div className="mt-12 text-sm text-gray-600 space-y-2">
                <p>CoHive, Inc. | PO Box 697 | Copake, NY 12516 | info@CoHiveSolutions.com</p>
