...
function AIResponseModal({ isOpen, onClose, title, content, meta }: AIResponseModalProps) {
  ...
  return (
    <div className="fixed inset-y-0 left-0 right-[350px] z-50 flex items-center justify-center p-4" style={{ backgroundColor: 'rgba(0,0,0,0.6)' }}>
    ...
    return (
      <div className="space-y-4">
        ...
        {showEditPopup && editingFile && (
          <div className="fixed inset-y-0 left-0 right-[350px] bg-black bg-opacity-50 flex items-center justify-center z-50">
