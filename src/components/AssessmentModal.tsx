              ...
              >
                <div className="flex flex-col gap-1.5 items-center">
                  ...
                  <button
                    ...
                    disabled={savingGem}
                    className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-amber-50 text-gray-900 text-sm font-medium rounded-full shadow-lg border border-amber-300 disabled:opacity-60 transition-all whitespace-nowrap"
                  >
                    {savingGem ? (
                      <SpinHex className="w-4 h-4" />
                    ) : (
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-purple-50 text-gray-900 text-sm font-medium rounded-full shadow-lg border border-purple-300 disabled:opacity-60 transition-all whitespace-nowrap"
                  >
                    {savingCheck ? (
                      <SpinHex className="w-4 h-4" />
                    ) : (
                  ...
                  <button
                    ...
                    disabled={savingCoal}
                    className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-gray-100 text-gray-900 text-sm font-medium rounded-full shadow-lg border border-gray-300 disabled:opacity-60 transition-all whitespace-nowrap"
                  >
                    {savingCoal ? (
                      <SpinHex className="w-4 h-4" />
                    ) : (
