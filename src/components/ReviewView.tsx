...
export function ReviewView({ projectFiles, onDeleteFiles }: ReviewViewProps) {
  ...
  return (
    <div className="space-y-4">
            ...
            <div className="relative">
              ...
              {showSortMenu && (
                <>
                  ...
                  <div 
                    className="fixed inset-y-0 left-0 right-[344px] z-40"
      ...
      {/* File Viewer Modal */}
      {viewingFile && (
        <div className="fixed inset-y-0 left-0 right-[344px] z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
