...
const personaContentMap = {
  ...
  'consumers-heavy-buyer':      safeRequire('./persona-content/consumers-heavy-buyer.json'),
  'consumers-medium-buyer':     safeRequire('./persona-content/consumers-medium-buyer.json'),
  'consumers-light-buyer':      safeRequire('./persona-content/consumers-light-buyer.json'),
  'consumers-loyal':            safeRequire('./persona-content/consumers-loyal.json'),
  'consumers-trier':            safeRequire('./persona-content/consumers-trier.json'),
  'consumers-non-buyer':        safeRequire('./persona-content/consumers-non-buyer.json'),
  'consumers-heavy-alcohol':    safeRequire('./persona-content/consumers-heavy-alcohol.json'),
  'consumers-light-alcohol':    safeRequire('./persona-content/consumers-light-alcohol.json'),
  'consumers-rtd':              safeRequire('./persona-content/consumers-rtd.json'),
  'consumers-premium':          safeRequire('./persona-content/consumers-premium.json'),
  'consumers-social':           safeRequire('./persona-content/consumers-social.json'),
  'consumers-health-conscious': safeRequire('./persona-content/consumers-health-conscious.json'),
